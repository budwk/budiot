...
public class SaTokenConfigure implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new SaInterceptor(handle -> {
                    SaRouter.match("/msg/channel/**", r -> StpUtil.checkLogin());
                    SaRouter.match("/msg/template/**", r -> StpUtil.checkLogin());
                    SaRouter.match("/msg/send/**", r -> StpUtil.checkLogin());
                    SaRouter.match("/msg/history/**", r -> StpUtil.checkLogin());
                }).isAnnotation(true))
                .addPathPatterns("/**");
    }
