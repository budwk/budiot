<template>
    <div class="app-container">
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button type="primary" icon="Plus" plain @click="handleCreate" v-permission="['iot.config.classify.create']">新增
                </el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button plain type="success" icon="Sort" @click="handleSort" v-permission="['iot.config.classify.update']">排序</el-button>
            </el-col>
            <el-col :span="1.5">
            ...
            <right-toolbar v-model:showSearch="showSearch" :extendSearch="false" :columns="columns"
                @quickSearch="quickSearch" :quickSearchShow="true" quickSearchPlaceholder="通过分类名称搜索" />
        </el-row>
                ...
                <template #default="scope">
                    <el-tooltip content="新增子类" placement="top">
                        <el-button link type="primary" icon="CirclePlus" @click="handleCreate(scope.row)"
                            v-permission="['iot.config.classify.create']"></el-button>
                        </el-tooltip>
                    <el-tooltip content="修改" placement="top">
                        <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                            v-permission="['iot.config.classify.update']"></el-button>
                        </el-tooltip>
                    <el-tooltip content="删除" placement="top">
                        <el-button link type="danger" icon="Delete"
                        @click="handleDelete(scope.row)" v-permission="['iot.config.classify.delete']"></el-button>
                    </el-tooltip>
                </template>
            </el-table-column>
        </el-table>

        <el-dialog title="新增分类" v-model="showCreate" width="40%">
                    ...
                    <el-col :span="24">
                        <el-form-item label="上级分类" prop="parentId">
                            <el-tree-select v-model="formData.parentId" :data="dictOptions"
                                ...
                                placeholder="选择上级分类" check-strictly :render-after-expand="false" style="width:100%"
                                />
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
        ...
        <el-dialog title="修改分类" v-model="showUpdate" width="40%">
        ...
        <el-dialog title="分类排序" v-model="showSort" width="30%">
...
import { doCreate, doUpdate, getInfo, getList, doDelete, doSort } from '/@/api/platform/iot/classify'
