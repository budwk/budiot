...
public interface SysUserService extends BaseService<Sys_user> {
    ...
    void checkLoginname(String loginname, String tenantId) throws BaseException;
    ...
    void checkMobile(String mobile, String tenantId) throws BaseException;
    ...
    Sys_user loginByPassword(String loginname, String passowrd, String tenantId) throws BaseException;
    ...
    Sys_user loginByMobile(String mobile, String tenantId) throws BaseException;
    ...
    Sys_user getUserByLoginname(String loginname, String tenantId) throws BaseException;
    ...
    void setPwdByLoginname(String loginname, String tenantId, String password) throws BaseException;
     ...
     * @return
     */
    String importUser(List<SysUserDTO> userList, String password, Boolean isUpdateSupport, String userId);
