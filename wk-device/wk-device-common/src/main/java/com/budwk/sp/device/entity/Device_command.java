...
@TableIndexes({@Index(name = "INDEX_DEVICE_COMMAND_DEVICE", fields = {"tenantId", "deviceId", "status"}, unique = false)})
public class Device_command extends BaseEntity implements Serializable {
