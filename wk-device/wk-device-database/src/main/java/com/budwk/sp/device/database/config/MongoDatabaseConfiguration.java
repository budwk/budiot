...
public class MongoDatabaseConfiguration {
    ...
    public MongoClient mongoClient(DeviceDatabaseProperties properties, Environment environment) {
        return MongoClients.create(resolveUri(properties, environment));
    }

    @Bean
    @ConditionalOnMissingBean
    public MongoDatabaseFactory mongoDatabaseFactory(MongoClient mongoClient, DeviceDatabaseProperties properties, Environment environment) {
    ...
    private String resolveUri(DeviceDatabaseProperties properties, Environment environment) {
