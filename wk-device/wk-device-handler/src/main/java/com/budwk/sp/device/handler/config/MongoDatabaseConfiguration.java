...
public class MongoDatabaseConfiguration {
    ...
    public MongoClient mongoClient(HandlerArchiveProperties properties, Environment environment) {
        return MongoClients.create(resolveUri(properties, environment));
    }

    @Bean
    @ConditionalOnMissingBean
    public MongoDatabaseFactory mongoDatabaseFactory(MongoClient mongoClient, HandlerArchiveProperties properties, Environment environment) {
    ...
    private String resolveUri(HandlerArchiveProperties properties, Environment environment) {
